<?php
/*
Plugin Name:    JinX Package Demo Data
...
class Jinx_Data_Demo_Plugin_Class{
    ...
    public static $theme_name = 'jinx';

    public static $demo_site = 'https://jinx.la-studioweb.com/';
    ...
    private function _setup_demo_data(){
        $this->preset_allows = array(
            ...
            // home
            '01-architecture-studio',
            '02-architecture-creative-studio',
            '03-architecture-agency',
            '04-architecture-slider',
            '05-architecture-project-showcase',
            '06-architecture-parallax',
            '07-architecture-masonry',
            '08-architecture-agency-minimal',
            '09-architecture-agency-dark',
            '10-architecture-studio-dark',
            '11-architecture-magazine',
            '12-interior-design-studio',
            '13-interior-creative-studio',
            '14-furniture-store',
            '15-home-decor-store',
            '16-decor-accessories',
            '17-furniture-creative',
            '18-furniture-creative-02',
        ...
        <div class="elementor-lastudio-demo lastudio-elements">
            <div id="la_demo_2019" class="lastudio-demo">
                ...
                <div class="lastudio-demo__list_wrapper">
                    <div class="lastudio-demo__list js-el la-isotope-container grid-items block-grid-2 mobile-block-grid-2 xmobile-block-grid-1" data-item_selector=".loop__item" data-la_component="DefaultMasonry">
                        <?php
                        foreach ($demo_lists as $demo){
...
add_action('plugins_loaded', function(){
    ...
    if(strpos(strtolower($theme->get_template()), 'jinx') === false){

        add_action( 'admin_notices', function(){
            printf( __( '%1$s"Jinx Package Demo Data" requires %3$s"Jinx"%4$s theme to be installed and activated. Please active %3$s"Jinx"%4$s to continue.%2$s', 'lastudio-demodata' ), '<div class="error"><p>', '</p></div>' ,'<strong>', '</strong>' );
        });
    ...
    Jinx_Data_Demo_Plugin_Class::get_instance();
}, 999);