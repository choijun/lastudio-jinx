        ...
        $this->_add_responsive_control(
            ...
            array(
                ...
                'selectors_dictionary' => array(
                    'flex-start'    => 'justify-content: flex-start; text-align: left;--lakit-navmenu--item-flex-grow:0;--lakit-navmenu--item-margin: 0',
                    'center'        => 'justify-content: center; text-align: center;--lakit-navmenu--item-flex-grow:0;--lakit-navmenu--item-margin: 0',
                    'flex-end'      => 'justify-content: flex-end; text-align: right;--lakit-navmenu--item-flex-grow:0;--lakit-navmenu--item-margin: 0',
